...
$logs = [
	'1.7.3' => [
		'[NEW] Добавлена возможность проверки версии с основного сайта',
		'[UPDATE] Обновлены функции админки до версии MH Admin 2.0.7',
		'[FIX] Добавлена обратная совместимость с PHP 7.2.x',
	],
	'1.7.2' => [
