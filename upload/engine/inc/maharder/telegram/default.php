...
//	segRow("Включить логи?", "Включает и выключает логирование запросов отправки", addCheckbox('logs', ($telebot['logs'] == 1) ? true : false), 'onof'),
	...
	segRow("Вывод сообщений", "Выбираем вывод сообщений в телеграм.<br>
			...
			<b>Сообщение с видео</b> - Вывод сообщения с видео, как основа, в качестве видео берётся первое указанное видео, другие игнорируются", addSelect('message_type', array('text' => "Текстовой", 'media'	=> "Галлерийный", 'photo'	=> "С постером", 'audio' => "С аудио", 'video' => "С видео"), 'Вывод сообщений', $telebot['message_type']), 'message_type'),
...
$blockcron = [
	...
	segRow('Список новостей ожидающих отправки', 'Новости, что ожидают отправки в телеграм, будут отображены в списке на отдельной странице',
		   "<a class=\"ui button\" href=\"{$adminlink}&do=cron\">Перейти</a>", ''),
...
$blocktemplates = [
	...
	segRow('Шаблон сообщения при редактировании новости', '<b>Разрешены BB-Code и HTML-Code</b>', addTextarea('editnews', $telebot['editnews'], 'Шаблон сообщения при редактировании новости'), 'editnews'),
