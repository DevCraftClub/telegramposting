...
$blocktemplates = [
	...
	segRow('Шаблон сообщения при добавлении новости', '<b>Разрешены BB-Code и HTML-Code</b><br>Следующие теги будут заменены на данные:<ul><li><b>%link%</b> - Ссылка на новость</li><li><b>%xf_field%</b> - выводит значение поля, вместо field название доп.поля</li><li><b>%autor%</b> - автор новости</li><li><b>%title%</b> - название новости</li><li><b>%descr%</b> - короткое описание новости</li></ul>', addTextarea('addnews', $telebot['addnews'], 'Шаблон сообщения при добавлении новости'), 'addnews'),
	segRow('Шаблон сообщения при редактировании новости', '<b>Разрешены BB-Code и HTML-Code</b><br>Следующие теги будут заменены на данные:<ul><li><b>%link%</b> - Ссылка на новость</li><li><b>%xf_field%</b> - выводит значение поля, вместо field название доп.поля</li><li><b>%autor%</b> - автор новости</li><li><b>%title%</b> - название новости</li><li><b>%descr%</b> - короткое описание новости</li><li><b>%editreason%</b> - если было заполнено поле \"Причина редактирования\", то используйте этот тег</li></ul>', addTextarea('editnews', $telebot['editnews'], 'Шаблон сообщения при редактировании новости'), 'editnews'),
];
$blockmessage = [
